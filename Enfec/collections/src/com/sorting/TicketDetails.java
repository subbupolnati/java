...
class Passenger{
	...
	public Passenger(String name, String pancard_no, long contact_no, String passport_no) {
		super();
		this.name = name;
		this.pancard_no = pancard_no;
		this.contact_no = contact_no;
...
class Plane_Details extends Passenger{
	public int plane_id;
	...
	public Plane_Details(String name, String pancard_no, long contact_no, String passport_no, int plane_id,
...
class Ticket extends Plane_Details{
	...
	public Ticket(String name, String pancard_no, long contact_no, String passport_no, int plane_id,
			String date_of_arrival, String arrival_time, String date_of_departure, String departure_time, String from,
...
public class TicketDetails {
	...
	public static void main(String[] args) {
		...
		getDetails();
		Passenger ti=new Ticket(name,pancard_no,contact_no,passport_no,plane_id,date_of_arrival,arrival_time,date_of_departure,departure_time,from,to,rate_of_ticket,no_of_seats,no_of_passenger,total_amount);
		ticketPrint();
