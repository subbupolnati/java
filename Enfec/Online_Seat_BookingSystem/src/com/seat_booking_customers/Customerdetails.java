...
public interface Customerdetails {
	...
	default void getcustomer_details() {	
		...
		Customer customer=new Customer(null,0,null,seat_no);
		int index=Collections.binarySearch(cus,customer,new SeatId());
		if(index<0)
...
//seat id sorting  class in created implementing comparator
