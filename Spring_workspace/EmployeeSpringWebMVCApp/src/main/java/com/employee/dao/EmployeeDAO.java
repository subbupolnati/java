...
public class EmployeeDAO {
	...
	public void deleteEmploye(Employee e) {
		String sql="delete from employee1 where empid="+e.getEmpid();
		template.update(sql);
	}
	public List<Employee> seletedEmploye(Employee e) {
		String sql="select * from employee1 where empid="+e.getEmpid();
