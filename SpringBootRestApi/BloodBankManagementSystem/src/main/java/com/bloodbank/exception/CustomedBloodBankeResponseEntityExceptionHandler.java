...
@ControllerAdvice
@RestController
public class CustomedBloodBankeResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	@Nullable
	...
	public final ResponseEntity<Object> handleEmployeeNotFoundException(BloodNotFoundException ex, WebRequest request) throws Exception {
		ExceptionResponse er=new ExceptionResponse(LocalDateTime.now(),ex.getMessage(),request.getDescription(false));
