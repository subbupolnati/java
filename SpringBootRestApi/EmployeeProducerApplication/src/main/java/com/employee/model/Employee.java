...
@Entity
@Table(name="employee2")//Employee table create using hibernate Jpa Repository
...
public class Employee {
	...
	//@JoinColumn(name="credential_userName",referencedColumnName = "userName",insertable = false,updatable = false,foreignKey = @javax.persistence.ForeignKey(value=ConstraintMode.CONSTRAINT))
